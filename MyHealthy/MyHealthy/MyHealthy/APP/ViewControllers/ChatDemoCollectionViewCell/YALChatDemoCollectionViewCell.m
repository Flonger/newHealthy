...
- (void)configureCellWithImage:(NSString *)image
                      userName:(NSString *)name
                   messageText:(NSString *)messageText
                      dateText:(NSString *)dateText {
    [self.chatImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://tnfs.tngou.net/image%@",image]]];
